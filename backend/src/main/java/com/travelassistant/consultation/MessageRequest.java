...
@Entity
@Table(
    name = "conversation_message_requests",
    uniqueConstraints =
        @UniqueConstraint(columnNames = {"conversation_id", "operation", "idempotency_key"}))
public class MessageRequest {
  ...
  public MessageRequest(Conversation c, String op, String key, String hash, Message u, Message a) {
    conversation = c;
    operation = op;
    this.key = key;
    this.hash = hash;
