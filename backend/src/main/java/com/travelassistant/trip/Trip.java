...
public class Trip extends SoftDeletableEntity {
  ...
  @Column(name = "preferences_json", nullable = false, columnDefinition = "json")
  ...
  private TripVersion currentVersion;
  ...
  private LocationReference destinationLocation;
  ...
  public Trip(
    ...
    this.days = (byte) days;
    this.travelers = (short) travelers;
    this.budgetAmount = budgetAmount;
    this.currency = currency;
    this.timezone = timezone;
    this.preferencesJson = preferencesJson;
    this.additionalRequirements = requirements;
    this.status = TripStatus.GENERATING;
  }

  public void publish(TripVersion version) {
  ...
  public void fail(String code) {
    if (currentVersion == null) status = TripStatus.FAILED;
    failureCode = code;
  }

  public void beginGeneration() {
    if (currentVersion == null) status = TripStatus.GENERATING;
    failureCode = null;
  }
  ...
  public void bindDestinationLocation(LocationReference location) {
  ...
  public TripVersion getCurrentVersion() {
  ...
  public LocationReference getDestinationLocation() {
