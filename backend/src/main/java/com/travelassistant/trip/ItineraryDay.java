...
@Table(
    name = "itinerary_days",
    uniqueConstraints = @UniqueConstraint(columnNames = {"trip_version_id", "day_number"}))
public class ItineraryDay {
  ...
  public ItineraryDay(TripVersion version, int number, LocalDate date, String summary) {
    tripVersion = version;
    dayNumber = (byte) number;
    this.date = date;
