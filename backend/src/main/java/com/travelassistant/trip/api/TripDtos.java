...
import com.travelassistant.realtime.api.RealtimeDtos.LocationView;
...
public final class TripDtos {
  ...
  public record DayView(
      int dayNumber, String date, String summary, List<ActivityView> activities) {}

  public record CategoryAmount(BudgetCategory category, Money amount) {}

  public record BudgetBreakdown(
      List<CategoryAmount> categories, Money total, boolean exceedsBudget, Money exceededBy) {}
  ...
  public record TripView(
      ...
      List<DayView> itinerary,
      String createdAt,
      LocationView destinationLocation) {}
