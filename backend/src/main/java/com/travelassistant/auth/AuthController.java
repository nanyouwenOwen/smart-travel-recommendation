...
public class AuthController {
  ...
  ApiResponse<AuthResponse> register(
      @Valid @RequestBody RegisterRequest body, HttpServletRequest req) {
  ...
  ApiResponse<AuthResponse> refresh(
      @Valid @RequestBody RefreshTokenRequest body, HttpServletRequest req) {
  ...
  private String id(HttpServletRequest req) {
    return (String) req.getAttribute(RequestIdFilter.ATTRIBUTE);
  }
}
