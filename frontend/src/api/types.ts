...
export interface BudgetBreakdown {
  categories: { category: Category; amount: Money }[];
  total: Money;
...
export interface LocationSearchResult extends Omit<LocationReference, "id"> {
  locationId: string;
}
export interface Trip extends TripSummary {
  ...
  destinationLocation?: LocationReference;
}
...
export type StreamEvent =
  | { id?: number; type: "ack"; data: StreamAck }
  | { id?: number; type: "delta"; data: StreamDelta }
  | { id?: number; type: "done"; data: StreamDone }
  | { id?: number; type: "error"; data: StreamFailure };
