...
- 验证：`scripts/check.sh --quick`、后端 43 项测试、前端 43 项测试、覆盖率 86.57%、格式/静态/类型/构建和依赖审计通过；GitHub Actions run `29163802316` 的完整 Compose/业务/SSE/备份恢复/k6/故障恢复、Trivy 和 release-candidate jobs 全部成功。
